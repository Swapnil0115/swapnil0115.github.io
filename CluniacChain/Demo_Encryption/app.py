...
#Replace AES with DES3 to check DES3
...
def GenerateSign(string, secret, read_key=None, write_key=None, delete_key=None, read=False, write=False, delete=False):
    ...
    #hashed = sha256(hash_value).hexdigest()
...
def index():
    if request.method == 'POST':
        ...
        encoded_signature, concat, readtime, hashingtime = GenerateSign(text, key, read_key=read_key, write_key=write_key, delete_key=delete_key, read=read, write=write, delete=delete)
        read_ciphered_key = ""
        write_ciphered_key = ""
        delete_ciphered_key = ""
        ...
        return render_template('output.html', encoded_signature = encoded_signature, read_ciphered_key = read_ciphered_key, write_ciphered_key = write_ciphered_key, delete_ciphered_key = delete_ciphered_key, readtime = readtime,hashingtime = hashingtime)
        #, alltime=alltime
        #, readwrite = readwrite
